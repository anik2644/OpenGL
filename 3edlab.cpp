...
void drawLine_3(int x_0, int y_0, int x_1, int y_1, int zone);
...
int main(int argc, char** argv)
{
    ...
    glutCreateWindow("Circle Drawing - 8 Way Symmetry");                            // creates the window and sets the title
